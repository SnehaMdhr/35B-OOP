...
public class Hello{
    public static void main(String[] args) {
        ...
        /* Extend/Modify the above program to print two additional lines: This is my first program
        ...
        *********
        ...
        System.out.println("A System.out.println statement has ( and ) and usually a String that starts and sends with a \" character.");
